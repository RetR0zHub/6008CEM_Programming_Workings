...
%           2 Birmingham -> Manchester(87), Swansea(143), Liverpool(99), Lecister(45)

%           3 Bath -> Swansea(96), London(100) 

%           4 Cambridge -> Lecister(72), Peterborough(43), London(60)

%           5 Peterborough -> Sheffield(93), Cambridge(43), Lecister(41)

%           6 Lecister -> Peterborough(41), Sheffield(70), Birmingham(45), Cambridge(72)

%           7 Sheffield  -> Manchester(42), Peterborough(93), Lecister(70)
...
%   London -> Cambridge -> Lecister -> Sheffield -> Manchester -> Liverpool -> Swansea = 60 + 72 + 70 + 42 + 33 + 167 = 444
